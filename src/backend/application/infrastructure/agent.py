...
def create_agent(
    ...
    Args:
        ...
        instrument: If True, wrap the agent with PydanticAI OTEL instrumentation.
    """
...
# ---------------------------------------------------------------------------
# Title agent factory (lightweight — no tools)
# ---------------------------------------------------------------------------

_TITLE_SYSTEM_PROMPT = (
    "You generate short chat titles (5-8 words) for conversations. "
